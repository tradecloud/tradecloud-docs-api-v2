---
description: Tradecloud services and portal open pull requests and changelog (Fri Feb 12 10:30:49 CET 2021)
---


## Open Pull Requests

1. [TC-6823](https://tradecloud.atlassian.net/browse/TC-6823) Marcel Terlouw can not log in on production, after he tested SSO on acceptance [Planned release 12-Feb-2021]
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 12-Feb-2021 10:26:52 CET | [#574](https://github.com/tradecloud/tradecloud-portal-angular/pull/574) |  Remove Damen users from SSO connections config | @marcmatt |  |
