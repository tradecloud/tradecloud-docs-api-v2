---
description: Tradecloud services and portal open pull requests and changelog (Mon Jun 28 13:30:43 CEST 2021)
---
...
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 28-Jun-2021 13:21:59 CEST | [#641](https://github.com/tradecloud/tradecloud-portal-angular/pull/641) |  Use activity createdAt field | @roy-tc |  |
| 2 | Services (Scala) | 28-Jun-2021 13:20:55 CEST | [#1543](https://github.com/tradecloud/tradecloud-microservices/pull/1543) |  Use original user and company when transforming Activity to ActivityView | @roy-tc |  |

2. [TC-7148](https://tradecloud.atlassian.net/browse/TC-7148) Sequence number [1] still missing after [10.00 s], saw unexpected seqNr [21] for persistenceId 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
2. [TC-7008](https://tradecloud.atlassian.net/browse/TC-7008) As portal user I want that TC maps SCSN unit codes to human readable unit names 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
