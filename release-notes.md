---
description: Tradecloud services and portal open pull requests and changelog (Wed Aug 26 15:30:54 CEST 2020)
---
...
2. [TC-6304](https://tradecloud.atlassian.net/browse/TC-6304) Cannot add new line to confirmed order when the buyer sents an updated order 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 26-Aug-2020 15:10:59 CEST | [#1304](https://github.com/tradecloud/tradecloud-microservices/pull/1304) | : Reissueing `Confirmed` order. Moving status to `InProgress` | @dmytrozheliuk |  |

3. [TC-6303](https://tradecloud.atlassian.net/browse/TC-6303) Order header is not updated when the buyer sends an order without lines 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
