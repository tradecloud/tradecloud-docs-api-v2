---
description: Tradecloud services and portal open pull requests and changelog (Wed Jun 2 15:30:40 CEST 2021)
---
...
2. [TC-7086](https://tradecloud.atlassian.net/browse/TC-7086) As DevOps I want to use pipenv instead of virtualenv, so that my Python developer experience will improve 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
