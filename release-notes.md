---
description: API and webhook connector changelog and release notes (Fri Apr 17 10:01:20 CEST 2020)
---
...
2. [TC-5048](#) As Damen I want to display part data in the order line detail page (Story - Should Have)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
7. [TC-5800](#) Disable 2FA API (Bug - High)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
