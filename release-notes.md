---
description: >-
  Tradecloud services and portal open pull requests and changelog (Fri May 1
  11:31:01 CEST 2020)
---
...
4. [TC-5850](https://tradecloud.atlassian.net/browse/TC-5850) Enrich incoming order response event in Company and User service
   ...
   | \# | Repository | Last Updated | PR\# | Title | Username | Comments |
   | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
   | 1 | Services \(Scala\) | 01-May-2020 06:37:43 CEST | [\#1172](https://github.com/tradecloud/tradecloud-microservices/pull/1172) | Enrich Order Response event | @aShevc |  |

5. [TC-5890](https://tradecloud.atlassian.net/browse/TC-5890) user profile setting changes fail until you manually change the profile picture.
...
11. [TC-5698](https://tradecloud.atlassian.net/browse/TC-5698) As DevOps I want persistent Scala services to handle Cassandra keyspace being unavailable
...
2. [TC-5902](https://tradecloud.atlassian.net/browse/TC-5902) As DevOps I want to delete Marathon PR groups when relevant PR is merged
...
6. [TC-5820](https://tradecloud.atlassian.net/browse/TC-5820) Design: create part data in the order line detail design
...
8. [TC-5890](https://tradecloud.atlassian.net/browse/TC-5890) user profile setting changes fail until you manually change the profile picture.
...
9. [TC-5896](https://tradecloud.atlassian.net/browse/TC-5896) Portal should logout should send the refresh token
...
10. [TC-5327](https://tradecloud.atlassian.net/browse/TC-5327) Change FTP settings header to FTPS/SFTP
...
11. [TC-5048](https://tradecloud.atlassian.net/browse/TC-5048) As Damen I want to display part data in the order line detail page
...
12. [TC-5873](https://tradecloud.atlassian.net/browse/TC-5873) As DevOps I want to lower the access token lifetime from 1 hour to 10 mins.
...
13. [TC-5743](https://tradecloud.atlassian.net/browse/TC-5743) FE: Support bulk actions for multiple order lines
...
14. [TC-5888](https://tradecloud.atlassian.net/browse/TC-5888) BE: Add enrichment and webhook support of OrderLinesItemChangedBySupplier event
...
16. [TC-5800](https://tradecloud.atlassian.net/browse/TC-5800) Disable 2FA API
...
17. [TC-5881](https://tradecloud.atlassian.net/browse/TC-5881) Implement parallel UAT running
...
18. [TC-5853](https://tradecloud.atlassian.net/browse/TC-5853) Move keyspaces creation from 'cli' to 'tcinfra'
...
19. [TC-5798](https://tradecloud.atlassian.net/browse/TC-5798) 2FA login api
...
20. [TC-5814](https://tradecloud.atlassian.net/browse/TC-5814) GitHub PR label flow: When PR approved first and then someone requires changes, 'ready: merge' label is not unset
...
21. [TC-5783](https://tradecloud.atlassian.net/browse/TC-5783) Refactor existing Python deployment scripts to be part of 'tcinfra'
...
22. [TC-4946](https://tradecloud.atlassian.net/browse/TC-4946) As a supplier I want to add my sales order number to an order in the propose dialog
...
23. [TC-5776](https://tradecloud.atlassian.net/browse/TC-5776) Documents are uploaded twice
...
24. [TC-5586](https://tradecloud.atlassian.net/browse/TC-5586) As a supplier I want to add my sales order number to a PO in the portal when accepting an order line
...
25. [TC-5746](https://tradecloud.atlassian.net/browse/TC-5746) BE: Bulk action events
...
26. [TC-5839](https://tradecloud.atlassian.net/browse/TC-5839) As Devops, I want shared microservices code to be in microservices.shared package
...
27. [TC-4218](https://tradecloud.atlassian.net/browse/TC-4218) As a supplier I want to receive incoming orders via the webhook connector
...
29. [TC-5834](https://tradecloud.atlassian.net/browse/TC-5834) As Vandeputte when I split a partial delivered line, the splitted line does not split the delivery correctly
...
30. [TC-5777](https://tradecloud.atlassian.net/browse/TC-5777) Move ~/.sbt/.credentials to ~/.sbt/tradecloud-artifactory.credentials
...
31. [TC-5770](https://tradecloud.atlassian.net/browse/TC-5770) Invalid time format for 'closedAt' field
...
32. [TC-5738](https://tradecloud.atlassian.net/browse/TC-5738) BE: Support bulk actions for multiple order lines
...
33. [TC-5660](https://tradecloud.atlassian.net/browse/TC-5660) As DevOps I want to use latest Debian version in Go services docker containers
...
34. [TC-5812](https://tradecloud.atlassian.net/browse/TC-5812) As DevOps I want to have automated changelog per service repository
...
35. [TC-5775](https://tradecloud.atlassian.net/browse/TC-5775) Supplier cannot download attached order document
...
36. [TC-4391](https://tradecloud.atlassian.net/browse/TC-4391) As DevOps I want to make Golang microservices use Kafka client SSL connection
...
37. [TC-5688](https://tradecloud.atlassian.net/browse/TC-5688) As user I want that downloaded documents are named after the fileName instead of the document: ObjectId
...
38. [TC-5642](https://tradecloud.atlassian.net/browse/TC-5642) As DevOps I want to migrate to tcinfra for accp and prod deployments
    ...
    | 8 | Services \(Go\) | 01-Apr-2020 19:33:30 CEST | [\#266](https://github.com/tradecloud/tradecloud-microservices-go/pull/266) | - Use 'tcinfra' instead fo 'deploy\_microservices.py' to dep… | @denys-kondartiuk |  |
    | 9 | Web Portal | 01-Apr-2020 19:25:24 CEST | [\#364](https://github.com/tradecloud/tradecloud-portal-angular/pull/364) | - Use 'tcinfra' instead fo 'deploy\_microservices.py' to dep… | @denys-kondartiuk |  |
    | 10 | Services \(Scala\) | 01-Apr-2020 19:10:24 CEST | [\#1128](https://github.com/tradecloud/tradecloud-microservices/pull/1128) | - Use 'tcinfra' instead of 'deploy\_microservices.py' for ac… | @denys-kondartiuk |  |
...
40. [TC-5574](https://tradecloud.atlassian.net/browse/TC-5574) Order data doesn't update in activity service
...
41. [TC-5274](https://tradecloud.atlassian.net/browse/TC-5274) recovery link \(for passwords\) does not work
...
42. [TC-4591](https://tradecloud.atlassian.net/browse/TC-4591) As Delaware SAP consultant I want to rearrange Voortman's SAP function modules
    ...
    | \# | Repository | Last Updated | PR\# | Title | Username | Comments |
    | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
    | 1 | Services \(Scala\) | 01-Apr-2020 16:55:13 CEST | [\#1127](https://github.com/tradecloud/tradecloud-microservices/pull/1127) | Re-enable Voortman ztradecloud\_interfaces in prod env | @marcmatt |  |
