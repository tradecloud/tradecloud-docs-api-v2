---
description: >-
  Tradecloud services and portal open pull requests and changelog (Tue Aug 4
  11:30:57 CEST 2020)
---
...
1. [TC-6029](https://tradecloud.atlassian.net/browse/TC-6029) Attach Document dialog seems to hang when uploading large files \(smaller than 100MB\)

   | \# | Repository | Last Updated | PR\# | Title | Username | Comments |
   | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
   | 1 | Web Portal | 04-Aug-2020 11:14:53 CEST | [\#458](https://github.com/tradecloud/tradecloud-portal-angular/pull/458) | add progress bar when uploading file and disable close events | @bohdantrc |  |
...
1. [TC-5662](https://tradecloud.atlassian.net/browse/TC-5662) As Gazelle I only want to receive an order line confirmation when the line is agreed and has no goods received
...
3. [TC-5006](https://tradecloud.atlassian.net/browse/TC-5006) As Technical Tester, I want to use a Mandrill API mock for my accp tests
...
4. [TC-6198](https://tradecloud.atlassian.net/browse/TC-6198) Net/gross price changes are shown in the activity stream during a reopen request, while there are no changes.
...
5. [TC-5921](https://tradecloud.atlassian.net/browse/TC-5921) Approve/reject proposal by buyer buttons are still visible when supplier has rejected/confirmed the line after the proposal.
...
7. [TC-6183](https://tradecloud.atlassian.net/browse/TC-6183) UserCompanyOrderSentByBuyer is retried for ever in case of a StateConflict
...
8. [TC-6127](https://tradecloud.atlassian.net/browse/TC-6127) Net/gross price changes are shown in the activity stream, while there are no changes.
...
9. [TC-6159](https://tradecloud.atlassian.net/browse/TC-6159) Remove reject button from Re-open order lines
...
10. [TC-6132](https://tradecloud.atlassian.net/browse/TC-6132) Remove the reopen request toggle out of our code
...
12. [TC-6166](https://tradecloud.atlassian.net/browse/TC-6166) Can’t upload any file to order
...
13. [TC-6102](https://tradecloud.atlassian.net/browse/TC-6102) IncomingOrderDocumentsAttachedByBuyer is retried forever when the purchase order number cannot be found
...
14. [TC-5930](https://tradecloud.atlassian.net/browse/TC-5930) Broken accept connection permissions check
...
15. [TC-5325](https://tradecloud.atlassian.net/browse/TC-5325) Admin user should not be able to change user's profile
...
16. [TC-5929](https://tradecloud.atlassian.net/browse/TC-5929) When a user authenticates with 2FA validate, a new refresh token is created
...
17. [TC-6093](https://tradecloud.atlassian.net/browse/TC-6093) order header process status does ignore lines which are later added to the order.
...
18. [TC-5936](https://tradecloud.atlassian.net/browse/TC-5936) Lower password link expiration timeout to 15 mins.
...
19. [TC-5332](https://tradecloud.atlassian.net/browse/TC-5332) Disable auto-complete for sensitive fields
...
20. [TC-6033](https://tradecloud.atlassian.net/browse/TC-6033) Action column not functional
...
21. [TC-6077](https://tradecloud.atlassian.net/browse/TC-6077) Integration settings cannot be disabled.
...
22. [TC-6094](https://tradecloud.atlassian.net/browse/TC-6094) All Document line activities of an issued order show a link to the document which is attached to line position 1
...
23. [TC-5916](https://tradecloud.atlassian.net/browse/TC-5916) Use enumeratum for enums to avoid JSON deserialization issues
...
24. [TC-6095](https://tradecloud.atlassian.net/browse/TC-6095) As buyer/supplier I want that documents are never removed from the buyer/supplier order/line
...
25. [TC-6140](https://tradecloud.atlassian.net/browse/TC-6140) Webhook API specs is missing event names
...
26. [TC-6099](https://tradecloud.atlassian.net/browse/TC-6099) Reissuing a line with less deliverySchedule positions will not trigger a reopen request.
...
27. [TC-6130](https://tradecloud.atlassian.net/browse/TC-6130) Hide reject order \(line\) buttons for suppliers
...
28. [TC-6108](https://tradecloud.atlassian.net/browse/TC-6108) As Eriks I want to test the integration by resending an order to my ERP system
...
30. [TC-6103](https://tradecloud.atlassian.net/browse/TC-6103) contact filter shows only up to 10 users.
...
31. [TC-5238](https://tradecloud.atlassian.net/browse/TC-5238) As Damen I want a separate system integration API account
...
32. [TC-6116](https://tradecloud.atlassian.net/browse/TC-6116) BE: Add integration user role
...
33. [TC-6124](https://tradecloud.atlassian.net/browse/TC-6124) In progress lines because of an reopen request can be selected for Bulk actions \(confirm/reject/propose\)
...
34. [TC-6042](https://tradecloud.atlassian.net/browse/TC-6042) BE: process cancelled indicator in order service, persist, publish event, create activity, close order line tasks
...
35. [TC-6050](https://tradecloud.atlassian.net/browse/TC-6050) Bulk confirm sales order dialog shown all selected order line positions.
...
36. [TC-6001](https://tradecloud.atlassian.net/browse/TC-6001) Review cancel request business logic and discus solutions for edge cases
