...
1. [TC-5833](#) Resolve replay Cluster Health persistence replay warnings 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
11. [TC-5789](#) Some SAP fetch requests are lost and not retried in case of SAP 503 Service Unavailable. 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 06-Apr-2020 15:15:29 CEST | #1138 |  Restructure SOAP logging statements to fix alerting | @roy-tc |  |

12. [TC-5737](#) Incorrect line id if position contains special symbols 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
2. [TC-5814](#) GitHub PR label flow: When PR approved first and then someone requires changes, &#39;ready: merge&#39; label is not unset 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
4. [TC-5783](#) Refactor existing Python deployment scripts to be part of &#39;tcinfra&#39; 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
5. [TC-4946](#) As a supplier I want to add my sales order number to an order in the propose dialog 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
10. [TC-5839](#) As Devops, I want shared microservices code to be in microservices.shared package 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
11. [TC-4218](#) As a supplier I want to receive incoming orders via the webhook connector 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
14. [TC-5834](#) As Vandeputte when I split a partial delivered line, the splitted line does not split the delivery correctly 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 10-Apr-2020 12:30:56 CEST | #1149 |  SAP confirm: remove delivered filter | @marcmatt |  |

15. [TC-5777](#) Move ~/.sbt/.credentials to ~/.sbt/tradecloud-artifactory.credentials 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
16. [TC-5770](#) Invalid time format for &#39;closedAt&#39; field 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
21. [TC-4391](#) As DevOps I want to make Golang microservices use Kafka client SSL connection 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
22. [TC-5688](#) As user I want that downloaded documents are named after the fileName instead of the document: ObjectId 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
23. [TC-5642](#) As DevOps I want to migrate to tcinfra for accp and prod deployments 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
30. [TC-5703](#) As DevOps I want to fix shimmering failing portal test 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 27-Mar-2020 13:48:27 CET | #360 |  unit test case issue | @jpuri |  |

31. [TC-5616](#) Rename Local currency to Transaction Currency and make Base currency mandatory in integration API 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
32. [TC-5704](#) Cassandra: Reduce amount of traffic between nodes 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 26-Mar-2020 19:57:42 CET | #1118 |  Add 4th C* node support | @vovinacci |  |

33. [TC-5644](#) As DevOps I want to simplify GitHub PR flow 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
34. [TC-5712](#) Make service versions consistent when running accp tests on Jenkins 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
39. [TC-5665](#) Workflow IndexRequest failed for large documents 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 18-Mar-2020 17:48:21 CET | #1099 |  IndexRequest exception logging | @roy-tc |  |

40. [TC-5641](#) As DevOps I want to resolve TODO list in service repositories related to deployment 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
41. [TC-5526](#) FE: Support attach document activities for order(line)s 
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
