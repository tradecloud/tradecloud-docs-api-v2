---
description: API and webhook connector changelog and release notes (Fri Apr 17 09:18:57 CEST 2020)
---


## Breaking changes

1. Story: [TC-4467](#) As a DevOps I want to be able to re-build a search index (Story)
...
1. Story: [TC-5048](#) As Damen I want to display part data in the order line detail page (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 17-Apr-2020 07:54:12 CEST | #1152 |  add update order line item API | @olegtradecloud |  |

2. Story: [TC-4467](#) As a DevOps I want to be able to re-build a search index (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
3. Technical task: [TC-5743](#) FE: Support bulk actions for multiple order lines (Technical task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 16-Apr-2020 12:24:56 CEST | #374 |  Development: create checkbox column with possibility select… | @bohdantrc |  |

4. Bug: [TC-5698](#) As DevOps I want persistent Scala services to handle Cassandra keyspace being unavailable (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
1. Story: [TC-5798](#) 2FA login api (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
2. Task: [TC-5814](#) GitHub PR label flow: When PR approved first and then someone requires changes, &#39;ready: merge&#39; label is not unset (Task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
3. Story: [TC-4467](#) As a DevOps I want to be able to re-build a search index (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
4. Task: [TC-5783](#) Refactor existing Python deployment scripts to be part of &#39;tcinfra&#39; (Task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
5. Story: [TC-4946](#) As a supplier I want to add my sales order number to an order in the propose dialog (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
10. Technical task: [TC-5839](#) As Devops, I want shared microservices code to be in microservices.shared package (Technical task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
11. Story: [TC-4218](#) As a supplier I want to receive incoming orders via the webhook connector (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
12. Epic: [TC-5494](#) Basic 2FA (Epic)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
14. Bug: [TC-5834](#) As Vandeputte when I split a partial delivered line, the splitted line does not split the delivery correctly (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 10-Apr-2020 12:30:56 CEST | #1149 |  SAP confirm: remove delivered filter | @marcmatt |  |

15. Task: [TC-5777](#) Move ~/.sbt/.credentials to ~/.sbt/tradecloud-artifactory.credentials (Task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
16. Bug: [TC-5770](#) Invalid time format for &#39;closedAt&#39; field (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
17. Technical task: [TC-5738](#) BE: Support bulk actions for multiple order lines (Technical task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 09-Apr-2020 09:58:42 CEST | #1121 | [TC-5465]: Bulk actions API specs and implementation | @dmytrozheliuk |  |

18. Story: [TC-5660](#) As DevOps I want to use latest Debian version in Go services docker containers (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Go) | 09-Apr-2020 08:51:28 CEST | #275 |  Fix &#39;x509: certificate signed by unknown authority&#39; | @vovinacci |  |

19. Task: [TC-5812](#) As DevOps I want to have automated changelog per service repository (Task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Go) | 08-Apr-2020 21:55:15 CEST | #273 |  Kafka: Update Confluent Kafka to 1.4.0 | @vovinacci |  |

20. Bug: [TC-5775](#) Supplier cannot download attached order document (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
21. Story: [TC-4391](#) As DevOps I want to make Golang microservices use Kafka client SSL connection (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
22. Story: [TC-5688](#) As user I want that downloaded documents are named after the fileName instead of the document: ObjectId (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
23. Story: [TC-5642](#) As DevOps I want to migrate to tcinfra for accp and prod deployments (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
30. Bug: [TC-5703](#) As DevOps I want to fix shimmering failing portal test (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 27-Mar-2020 13:48:27 CET | #360 |  unit test case issue | @jpuri |  |

31. Story: [TC-5616](#) Rename Local currency to Transaction Currency and make Base currency mandatory in integration API (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
32. Technical task: [TC-5704](#) Cassandra: Reduce amount of traffic between nodes (Technical task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 26-Mar-2020 19:57:42 CET | #1118 |  Add 4th C* node support | @vovinacci |  |

33. Story: [TC-5644](#) As DevOps I want to simplify GitHub PR flow (Story)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
34. Bug: [TC-5712](#) Make service versions consistent when running accp tests on Jenkins (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
35. Bug: [TC-5714](#) Webhook HTTP POST/PUT should send HTTP header Content-Type application/json (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Go) | 20-Mar-2020 16:33:07 CET | #260 |  - set webhook request content type | @olegtradecloud |  |

36. Bug: [TC-5658](#) Order service receives unknown message EnrichConversation (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 20-Mar-2020 12:55:47 CET | #1098 |  Support order line positions with hyphens | @roy-tc |  |

37. Technical task: [TC-5655](#) BE: improve tests and implementation for document attachments (Technical task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 19-Mar-2020 16:26:06 CET | #1100 | : Added implementation based on *ing patterns. Extended tests | @dmytrozheliuk |  |

38. Technical task: [TC-5524](#) BE: implement webhook trigger for attached documents (Technical task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
39. Bug: [TC-5665](#) Workflow IndexRequest failed for large documents (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 18-Mar-2020 17:48:21 CET | #1099 |  IndexRequest exception logging | @roy-tc |  |

40. Bug: [TC-5641](#) As DevOps I want to resolve TODO list in service repositories related to deployment (Bug)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
41. Technical task: [TC-5526](#) FE: Support attach document activities for order(line)s (Technical task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 17-Mar-2020 11:56:26 CET | #349 |  Add details of attached document to activity. | @jpuri |  |

42. Technical task: [TC-5659](#) Refactor Kafka tests in shared library to use with Confluent Kafka (Technical task)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
