---
description: API and webhook connector changelog and release notes (Fri Apr 17 10:10:59 CEST 2020)
---


## Breaking changes

1. [TC-4467](#) As a DevOps I want to be able to re-build a search index (Story - Must Have)  %!s(MISSING)
...
1. [TC-5833](#) Resolve replay Cluster Health persistence replay warnings (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 17-Apr-2020 09:58:42 CEST | #1164 |  Investigate - Trigger build | @roy-tc |  |

2. [TC-5048](#) As Damen I want to display part data in the order line detail page (Story - Should Have) [Planned release date 24-Apr-2020] %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 17-Apr-2020 07:54:12 CEST | #1152 |  add update order line item API | @olegtradecloud |  |

3. [TC-4467](#) As a DevOps I want to be able to re-build a search index (Story - Must Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
4. [TC-5743](#) FE: Support bulk actions for multiple order lines (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 16-Apr-2020 12:24:56 CEST | #374 |  Development: create checkbox column with possibility select… | @bohdantrc |  |

5. [TC-5698](#) As DevOps I want persistent Scala services to handle Cassandra keyspace being unavailable (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
7. [TC-5800](#) Disable 2FA API (Bug - High) [Planned release date 23-Apr-2020] %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 15-Apr-2020 12:16:53 CEST | #1153 |  disable 2fa | @TizianoPerrucci |  |

8. [TC-4751](#) Add a flattened line event index usable by Kibana (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 15-Apr-2020 11:00:30 CEST | #772 |  add a flattened event index for kibana | @snevyd |  |

9. [TC-4862](#) Remove `/` path in API&#39;s (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 13-Apr-2020 15:58:03 CEST | #989 |  Proposal for routes cleanup | @roy-tc |  |

10. [TC-5767](#) As DevOps I want to stop misbehaved companies syncing legacy orders to Tradecloud1 (Bug - Critical)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 09-Apr-2020 13:40:02 CEST | #1143 |  Add migration whitelist, remove roles based rules | @marcmatt |  |

11. [TC-5789](#) Some SAP fetch requests are lost and not retried in case of SAP 503 Service Unavailable. (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 06-Apr-2020 15:15:29 CEST | #1138 |  Restructure SOAP logging statements to fix alerting | @roy-tc |  |

12. [TC-5737](#) Incorrect line id if position contains special symbols (Bug - Critical)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
1. [TC-5798](#) 2FA login api (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
2. [TC-5814](#) GitHub PR label flow: When PR approved first and then someone requires changes, &#39;ready: merge&#39; label is not unset (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
4. [TC-5783](#) Refactor existing Python deployment scripts to be part of &#39;tcinfra&#39; (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
5. [TC-4946](#) As a supplier I want to add my sales order number to an order in the propose dialog (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
6. [TC-5776](#) Documents are uploaded twice  (Bug - Blocker)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 14-Apr-2020 10:59:01 CEST | #371 | : Fixing bug related to double attaching document | @dmytrozheliuk |  |

7. [TC-5586](#) As a supplier I want to add my sales order number to a PO in the portal when accepting an order line (Story - Must Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 14-Apr-2020 10:55:28 CEST | #372 |  Development: create confirm modal with input | @bohdantrc |  |

8. [TC-5746](#) BE: Bulk action events (Story - Should Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 14-Apr-2020 10:04:13 CEST | #1150 | : Adjusted activity for bulk order action events | @dmytrozheliuk |  |

9. [TC-5555](#) Continuous delivery and operations (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
10. [TC-5839](#) As Devops, I want shared microservices code to be in microservices.shared package (Story - Should Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
11. [TC-4218](#) As a supplier I want to receive incoming orders via the webhook connector (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
12. [TC-5494](#) Basic 2FA (Story - Must Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
14. [TC-5834](#) As Vandeputte when I split a partial delivered line, the splitted line does not split the delivery correctly (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 10-Apr-2020 12:30:56 CEST | #1149 |  SAP confirm: remove delivered filter | @marcmatt |  |

15. [TC-5777](#) Move ~/.sbt/.credentials to ~/.sbt/tradecloud-artifactory.credentials (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
16. [TC-5770](#) Invalid time format for &#39;closedAt&#39; field (Bug - Blocker)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
17. [TC-5738](#) BE: Support bulk actions for multiple order lines (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 09-Apr-2020 09:58:42 CEST | #1121 | [TC-5465]: Bulk actions API specs and implementation | @dmytrozheliuk |  |

18. [TC-5660](#) As DevOps I want to use latest Debian version in Go services docker containers (Story - Should Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Go) | 09-Apr-2020 08:51:28 CEST | #275 |  Fix &#39;x509: certificate signed by unknown authority&#39; | @vovinacci |  |

19. [TC-5812](#) As DevOps I want to have automated changelog per service repository (Story - Should Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Go) | 08-Apr-2020 21:55:15 CEST | #273 |  Kafka: Update Confluent Kafka to 1.4.0 | @vovinacci |  |

20. [TC-5775](#) Supplier cannot download attached order document (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
21. [TC-4391](#) As DevOps I want to make Golang microservices use Kafka client SSL connection (Story - Should Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
22. [TC-5688](#) As user I want that downloaded documents are named after the fileName instead of the document: ObjectId (Story - Should Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
23. [TC-5642](#) As DevOps I want to migrate to tcinfra for accp and prod deployments (Story - Must Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
30. [TC-5703](#) As DevOps I want to fix shimmering failing portal test (Bug - Blocker)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 27-Mar-2020 13:48:27 CET | #360 |  unit test case issue | @jpuri |  |

31. [TC-5616](#) Rename Local currency to Transaction Currency and make Base currency mandatory in integration API (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
32. [TC-5704](#) Cassandra: Reduce amount of traffic between nodes (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 26-Mar-2020 19:57:42 CET | #1118 |  Add 4th C* node support | @vovinacci |  |

33. [TC-5644](#) As DevOps I want to simplify GitHub PR flow (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
34. [TC-5712](#) Make service versions consistent when running accp tests on Jenkins (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
35. [TC-5714](#) Webhook HTTP POST/PUT should send HTTP header Content-Type application/json (Bug - Critical)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Go) | 20-Mar-2020 16:33:07 CET | #260 |  - set webhook request content type | @olegtradecloud |  |

36. [TC-5658](#) Order service receives unknown message EnrichConversation (Bug - Critical)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 20-Mar-2020 12:55:47 CET | #1098 |  Support order line positions with hyphens | @roy-tc |  |

37. [TC-5655](#) BE: improve tests and implementation for document attachments (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 19-Mar-2020 16:26:06 CET | #1100 | : Added implementation based on *ing patterns. Extended tests | @dmytrozheliuk |  |

38. [TC-5524](#) BE: implement webhook trigger for attached documents (Story - Should Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
39. [TC-5665](#) Workflow IndexRequest failed for large documents (Bug - Critical)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Services (Scala) | 18-Mar-2020 17:48:21 CET | #1099 |  IndexRequest exception logging | @roy-tc |  |

40. [TC-5641](#) As DevOps I want to resolve TODO list in service repositories related to deployment (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
...
41. [TC-5526](#) FE: Support attach document activities for order(line)s (Story - Should Have)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
| 1 | Web Portal | 17-Mar-2020 11:56:26 CET | #349 |  Add details of attached document to activity. | @jpuri |  |

42. [TC-5659](#) Refactor Kafka tests in shared library to use with Confluent Kafka (Bug - High)  %!s(MISSING)
| #    | Repository | Last Updated | PR#  | Title | Username | Comments |
| :--- | :---       | :---         | :--- | :---  | :---     | :--- |
