...
* [Buyer order process](buyer/README.md)
  ...
  * [Receive an order response](buyer/receive/README.md)
    * [Choose webhook or polling API](buyer/receive/receive-order-response-api.md)
  ...
  * [Cancel an order](buyer/cancel.md)
* [Supplier order process](supplier/README.md)
  * [Supplier order process overview](supplier/overview.md)
  * [Receive an order](supplier/receive/README.md)
    * [Choose webhook or polling API](supplier/receive/receive-order-api.md)
