...
* `deliverySchedule.status`: The logistics status of this delivery line according to the buyer. A `position` MUST be used when providing `status`.

{% hint style="info" %}
deliverySchedule status is one of:
