...
* [Test environments](environments.md#test-environments)
* [Acceptance test environment](environments.md#acceptance-test-environment)
* [Production environment](environments.md#production-environment)
...
There is one [acceptance test environment](https://api.accp.tradecloud1.com) which is targetted on Tradecloud customers. Buyers and suppliers can test new features and develop and test their Tradecloud API integration. It has an availability SLA of 95% per month, measured 8:00-18:00 CE\(S\)T on working days \(10/5\), except for [planned maintenance](environments.md#planned-maintenance)

## Production environment

There is one [production environment](https://api.tradecloud1.com/) a.k.a. LIVE environment. It has an availability SLA of 99,5% per month, measured 24/7, except for [planned maintenance](environments.md#planned-maintenance)
